<x-app-layout>
    <div class="max-w-3xl mx-auto w-full space-y-8 pb-16 animate-fade-up">
        ...
        <div class="bg-white p-8 md:p-10 rounded-[2rem] border border-slate-200 shadow-sm relative overflow-hidden">
            ...
            <div class="mb-8">
                <h2 class="text-2xl font-black text-[#003366] uppercase tracking-tight">Tambah Entitas Baru</h2>
                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Registrasi Cabang / Lokasi Pelabuhan</p>
            </div>
            ...
            <form action="{{ route('admin.entities.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: PT TERMINAL PETIKEMAS" class="w-full border-slate-200 bg-slate-50 rounded-xl text-sm font-bold p-4 focus:ring-4 focus:ring-blue-50 focus:border-[#003366] transition-all uppercase" required>
                ...
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" placeholder="Contoh: TPK" class="w-full border-slate-200 bg-slate-50 rounded-xl text-sm font-bold p-4 focus:ring-4 focus:ring-blue-50 focus:border-[#003366] transition-all uppercase" required>
                    <p class="text-[10px] text-slate-400 font-bold mt-2 ml-1">*Kode ini digunakan untuk identifikasi cepat pada sistem pelaporan.</p>
                ...
                <div class="pt-8 border-t border-slate-100 flex flex-col sm:flex-row gap-4">
                    <button type="submit" class="flex-1 bg-[#003366] hover:bg-[#001e3c] text-white py-4 rounded-xl text-xs font-black uppercase tracking-widest shadow-lg shadow-blue-900/20 transition-all flex items-center justify-center gap-2">
                        <i class="fas fa-save text-blue-400"></i> Simpan Entitas
                    </button>
